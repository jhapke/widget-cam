...
| chilipeppr.load() URL | http://raw.githubusercontent.com/jhapke/widget-cam/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/electricgearnuts/widget-cam |
| Github URL            | http://github.com/jhapke/widget-cam |
| Test URL              | https://preview.c9users.io/electricgearnuts/widget-cam/widget.html |
...
The table below shows, in order, the methods and properties inside the widget/element.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-widget-cam"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Widget / Cam"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"This widget loads a webcam view in ChiliPeppr via WebRTC."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/jhapke/widget-cam/master/auto-generated-widget.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/electricgearnuts/widget-cam"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/jhapke/widget-cam"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://widget-cam-electricgearnuts.c9users.io/widget.html"</td></tr><tr valign="top"><td>publish</td><td>object</td><td>Please see docs above.<br><br>Define the publish signals that this widget/element owns or defines so that
